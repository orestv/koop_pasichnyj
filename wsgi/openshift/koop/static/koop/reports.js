...
(function() {
  var NODETYPE_FOLDER, NODETYPE_REPORT, document_loaded, enable_tabs, folder_create_before_submit, folder_create_success, folder_node_selected, init_folder_create_form, init_upload_form, node_selected, report_node_selected, set_upload_progress_percentage, setup_tree, upload_before_submit, upload_progress, upload_success;
  ...
  init_folder_create_form = function() {
    ...
    return $('#btnFolderCreateForm_Submit').click(function() {
